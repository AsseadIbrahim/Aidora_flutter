...
import 'package:first_flutter/Models/Org/OrgOne/Report.dart';
...
class Orgone extends StatelessWidget {
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Text('Report Log', style: TextStyle(color: Colors.blue)),
              ],
            ),
            const SizedBox(height: 12),
  ...
  Widget _buildRecentRequestCard(req) {
    ...
    switch (req['state']) {
      case 'FOOD':
        typeColor = Color.fromARGB(255, 233, 161, 67);
        break;
      case 'MEDICAL':
        typeColor = Color.fromARGB(255, 14, 43, 80);
        break;
      case 'SHELTER':
        typeColor = Color.fromARGB(255, 107, 9, 211);
        break;
      default:
  ...
  Widget _buildCompletedTaskCard(Map<String, dynamic> task) {
    bool state = task['report_reviewed'];
    return Container(
      margin: const EdgeInsets.only(bottom: 12),
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
            ...
            children: [
              Container(
                ...
                child: state
                    ...
                    : Icon(Icons.task, color: Colors.green, size: 16),
              ),
